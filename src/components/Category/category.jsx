      ...
      <Grid container spacing={3}>
        <Grid item xs={4} >
         <div className="category-links" >
          ...
          <Link to ="/category/men's clothing" className="category-link" onClick={() => handleAll()} >
          ...
          <Link to ="/category/women's clothing" className="category-link" onClick={() => handleAll()}  >
            <img src={women} alt="women clothing" />
           <span>
              Women Clothing
           </span>
          </Link>
           <Link to ="/category/jewelery" className="category-link" onClick={() => handleAll()} >
             <img src={jewelery} alt="jewelery" />
            <span >Jewelery</span>
      
          </Link>
           <Link to="/category/electronics" className="category-link" onClick={() => handleAll()}  >
             <img src={electronics} alt="electronics" />
           <span>
              Electronics
           </span>
          </Link>
           <Link to="/category/skin care" className="category-link" onClick={() => handleAll()}  >
              <img src={skin} alt="skin care" />
            <span>
               Skin Care
            </span>
           </Link>
          <Link to="/category/food" className="category-link" onClick={() => handleAll()}  >
             <img src={food} alt="food" />
           <span>
              Food
           </span>
          </Link>
           <Link to="/category/sport" className="category-link" onClick={() => handleAll()}  >
